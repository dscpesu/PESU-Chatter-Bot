...
for number in range(1, 3):
    site = 'https://faculty.pes.edu/department-science-&-humanities' + '?page=' + str(number)
...
d=['Designation']
e=['E-mail']
with open('E:\collage\DSC_Project\PESU-Chatter-Bot\data\Faculty\CSVs\s&hdata.csv', 'w+') as f:
    writer = csv.writer(f)
