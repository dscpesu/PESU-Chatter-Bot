...
for number in range(1, 4):
    site = 'https://faculty.pes.edu/department-mechanical' + '?page=' + str(number)
...
d=['Designation']
e=['E-mail']
with open('E:\collage\DSC_Project\PESU-Chatter-Bot\data\Faculty\CSVs\mechdata.csv', 'w+') as f:
    writer = csv.writer(f)
